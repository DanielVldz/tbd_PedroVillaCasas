...
select e1.id_especie, e1.bicho, e2.id_especie, e2.bicho from especieEvolucion
inner join especie e1 on e1.id_especie = especieEvolucion.id_especie_actual
inner join especie e2 on e2.id_especie = especieEvolucion.id_especie_siguiente
where e1.id_especie = e2.id_especie